...
- **Omarchy:** v3.8.0 (pinned)
- **Omarchy Releases:** All versions up to v3.8.0
- **Arch Wiki:** Latest (updated via script)
- **Hyprland Wiki:** Latest (updated via script)

**Note:** This server contains Omarchy v3.8.0 documentation. Some features may differ if you are on a different version.
...
- Restore Omarchy v3.8.0 docs from snapshot
...
**Note:** Omarchy documentation and release notes remain at v3.8.0 (pinned version). To update Arch Wiki and Hyprland documentation, re-run the setup script or manually execute the download and processing scripts.
...
├── data/
│   ├── snapshots/
│   │   └── omarchy-3.8.0-processed/ # Version snapshot (in Git)
