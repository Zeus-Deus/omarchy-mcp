...
**Note:** This server contains Omarchy v3.5.1 documentation. Some features may differ if you are on a different version.
...
- Restore Omarchy v3.5.1 docs from snapshot
...
**Note:** Omarchy documentation and release notes remain at v3.5.1 (pinned version). To update Arch Wiki and Hyprland documentation, re-run the setup script or manually execute the download and processing scripts.
...
├── data/
│   ├── snapshots/
│   │   └── omarchy-3.5.1-processed/ # Version snapshot (in Git)
