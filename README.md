...
- **Omarchy:** v3.7.1 (pinned)
- **Omarchy Releases:** All versions up to v3.7.1
- **Arch Wiki:** Latest (updated via script)
- **Hyprland Wiki:** Latest (updated via script)

**Note:** This server contains Omarchy v3.7.1 documentation. Some features may differ if you are on a different version.
...
- Restore Omarchy v3.7.1 docs from snapshot
...
**Note:** Omarchy documentation and release notes remain at v3.7.1 (pinned version). To update Arch Wiki and Hyprland documentation, re-run the setup script or manually execute the download and processing scripts.
...
├── data/
│   ├── snapshots/
│   │   └── omarchy-3.7.1-processed/ # Version snapshot (in Git)
